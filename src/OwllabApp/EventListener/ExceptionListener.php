...
use OwllabApp\EventListener\Interfaces\ExceptionListenerInterface;
 ...
 */
class ExceptionListener extends BaseExceptionListener implements ExceptionListenerInterface {
    /**
